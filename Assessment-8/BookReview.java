...
public class BookReview {
    public static void main(String[] args) {
        ...
        bookReviews.add(new Book("Book 1", 4));
        bookReviews.add(new Book("Book 2", 7));
        bookReviews.add(new Book("Book 3", 9));
        bookReviews.add(new Book("Book 4", 3));
        bookReviews.add(new Book("Book 5", 6));
        bookReviews.add(new Book("Book 6", 2));
